...
//	private Group MARGINAL_EDGE = new Group("marginal_edge");
    ...
    /* Computes the angle / distance of all child nodes  <----Es llamado recursivamente
     */
    ...
    private void computeNodeProperties(Node node) {
        ...
        for (Iterator iterator = edges.iterator(); iterator.hasNext();) {
            ...
            childProp.distance = Math.max(minDistance, getSize(node) + getSize(child));
