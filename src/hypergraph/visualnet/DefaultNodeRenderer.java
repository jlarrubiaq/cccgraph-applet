...
public class DefaultNodeRenderer extends JComponent implements NodeRenderer {
    ...
    public void configure(GraphPanel c, ModelPoint mp, Node node) {
        ...
        if (node == null) {
            ...
            /*if (node.getGroup() != null && node.getGroup().getName().equals("item")) //textColour = Color.getHSBColor(62.4f, 31f, 96.1f);
            {
                textColour = Color.BLUE;
            } 
            else {
                textColour = (Color) attrMgr.getAttribute(GraphPanel.NODE_FOREGROUND, node);
            }*/
            textColour = (Color) attrMgr.getAttribute(GraphPanel.NODE_FOREGROUND, node);
            if (textColour != null) {
            ...
            if (((GraphPanel) c).getHoverElement() == node) {
                ...
                //Color fillColour2 = new Color((int) (fillColour.getRed()*1.1), (int) (fillColour.getGreen()*1.1), (int) (fillColour.getBlue()*1.1), fillColour.getAlpha());
                Color fillColour2 = fillColour.darker();
                getTextRenderer().setBackground(fillColour2);
    ...
    public void paintComponent(Graphics g) {
        ...
        if (getBackground() != null) {
            ...
            // g.fillRect(1, 10, getWidth()-2, getHeight()-20);
        }
        if (graphPanel.hasExpander(node)) {
