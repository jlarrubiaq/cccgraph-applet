...
public class ArrowLineRenderer extends DefaultLineRenderer {
    ...
    /**
     * Establece si la arista se pinta desviada
     * @param desviado,
     */
    ...
    public void paint(Graphics g) {
        ...
        Point[] lineSegments = panel.getProjector().getLineSegments(start, end, panel, desviado);
        ...
        if (_showArrows) {
            //int fromIndex = lineSegments.length / 2 - 1  ;
            //int toIndex = fromIndex + 1;
            int fromIndex = (int) Math.round(lineSegments.length * 0.55);
            int toIndex = fromIndex + 1;
    ...
    protected void drawArrow(
        ...
        int width = (int) Math.round(20);
        int height = (int) Math.round(20);
