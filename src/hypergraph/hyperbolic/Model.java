...
/** Dieses Interface ist Grundlage for alle Beschreibungen der hyperbolischen Ebene.
...
public interface Model {
    ...
    /** Return a traslation from the zero point to the point <code>z</code>
     * @param z Target point
     * @param t Distance between the source point and the target point
     */
    public Isometry getTranslation(ModelPoint z);

    /**  Return a traslation of a point in a distance <code>t</code>
     * @param z point translated
     * 
     */
    ...
    /** Return a traslation from a point to another point 
     * @param z1 Source point
     * @param z2 Target point
     */
    public Isometry getTranslation(ModelPoint z1, ModelPoint z2);

    /** Return a traslation from a point in a distance <code>t</code> to another point 
     * @param z1 Source point
     * @param z2 Target point
     * @param t Distance between the source point and the target point
     */
    ...
    /** Return a traslation of a vector in a distance <code>t</code>
     * @param vector vector with the direction
     * @param t Distance between the source point and the target point
     */
